...
public class GestoreCorsiController {
    ...
    @FXML // fx:id="btnStstCorsi"
    private Button btnStstCorsi; // Value injected by FXMLLoader
    ...
    void initialize() {
        ...
        assert btnStstCorsi != null : "fx:id=\"btnStstCorsi\" was not injected: check your FXML file 'GestoreCorsi.fxml'.";
